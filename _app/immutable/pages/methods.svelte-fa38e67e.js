import{S as as,i as os,s as ns,l as a,r,a as d,m as o,n,u as l,h as s,c as u,p as t,b as rs,J as e,E as Tt}from"../chunks/index-d79583a8.js";function ls(ss){let c,i,M,fe,ge,b,ye,j,be,je,we,N,Ce,_e,f,Ee,w,ze,Pe,C,Te,Ie,Se,R,Ae,We,g,Ue,_,He,xe,D,ke,De,Le,O,Me,Ne,q,Re,Oe,p,G,qe,Ge,Q,Qe,Fe,v,L,F,Ke,Je,Ve,E,K,Ye,Be,z,J,Xe,Ze,V,$e,et,P,Y,tt,st,y,B,at,ot,X,nt,rt,Z,lt,it,T,$,dt,ut,ee,te,ht,ct,se,pt,mt,m,ae,vt,ft,I,gt,S,yt,bt,jt,oe,wt,Ct,A,_t,W,Et,zt;return{c(){c=a("div"),i=a("section"),M=a("h2"),fe=r("Housing Insecurity Metric"),ge=d(),b=a("p"),ye=r(`We calculate the housing insecurity metric using county-level student homelessness counts
